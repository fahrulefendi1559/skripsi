...
class SurattugasController extends Controller
{
    public function getsurattugas(){
    	...
    	return view('admin.surattugas')->with([
    ...
    public function cari(Request $request)
    {
        ...
        return view('admin.carisurattugas')->with([
            'filter'            => $filter,
            'jenis_tugas'       => $jenis_tugas,
            'suratperiode'      => $suratperiode,
            'surat_tugas'       => $surat_tugas
    ...
    public function edit($id){
        ...
        return view('admin.editsurattugas', compact('surattugas','id'));
    }
    ...
    public function update(Request $request,$id){
        ...
        $tugas->save();
        return redirect()->route('admin.getsurattugas')->with('update','Data Berhasil Diupdate');
    ...
    public function delete($id){
        ...
        return redirect('admin/surattugas')->with('delete','Data Berhasil Dihapus ');
    }
