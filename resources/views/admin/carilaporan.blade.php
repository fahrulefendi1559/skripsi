                ...
                <!--  PANEL TAB SURAT MASUK  -->
                    <div role="tabpanel" id="tab-1" class="tab-pane active">
                        <div class="panel-body">
                            <div class="col-md-2 pull-left">
                                <a href="{{ url('admin/laporan/suratmasuk/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                            </div>
                            <br> <br>
                    ...
                    <div role="tabpanel" id="tab-2" class="tab-pane">
                        ...
                        <!-- laporan surat keluar -->
                            <div class="col-md-2 pull-left">
                                <a href="{{ url('admin/laporan/suratmasuk_ex/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                            </div>
                            <br> <br>
                    ...
                    <div role="tabpanel" id="tab-3" class="tab-pane">
                        ...
                        <!-- laporan surat keluar -->
                            <div class="col-md-2 pull-left">
                                <a href="{{ url('admin/laporan/suratkeluar/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                            </div>
                            <br> <br>
                    ...
                    <div role="tabpanel" id="tab-4" class="tab-pane">
                        <div class="panel-body">
                            <div class="col-md-2 pull-left">
                                <a href="{{ url('admin/laporan/suratkeluar_ex/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                            </div>
                            <br> <br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables" >
                    ...
                    <div role="tabpanel" id="tab-5" class="tab-pane">
                        <div class="panel-body">
                            <div class="col-md-2 pull-left">
                                <a href="{{ url('admin/laporan/surattugas/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                            </div>
                            <br> <br>
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover dataTables" >
