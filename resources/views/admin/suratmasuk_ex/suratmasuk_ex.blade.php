        ...
        <div class="col-lg-12">
            <div class="row">
                <div class="col-sm-3 m-b-xs">
                    <form action="suratmasuk_ex/cari" method="GET">
		                    ...
		                    <tr >
                                ...
                                <td><center>
		                        	...
		                        	<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <a href="{{ route('admin.viewpdfsuratmasuk_ex', ['id' => $masuk->id]) }}" class="btn btn-simple btn-info btn-xs " target="blank"><i class="fa fa-file-pdf-o"></i></a>

                                        <a href="{{url ('admin/suratmasuk_ex/edit/'. $masuk->id)}}" class="btn btn-simple btn-primary btn-xs " ><i class="fa fa-edit"></i></a>

                                        <a href="{{url ('admin/suratmasuk_ex/delete/'. $masuk->id)}}" class="btn btn-simple btn-danger btn-xs delete" onclick="return confirm('Anda Yakin Akan Menghapus Data Ini')" ><i class="fa fa-trash"></i></a>
