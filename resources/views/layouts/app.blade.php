                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a1.jpg')}}">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a2.jpg')}}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a3.jpg')}}">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a4.jpg')}}">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a8.jpg')}}">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="float-left text-center">
                                        <img alt="image" class="rounded-circle message-avatar" src="{{ asset('asset/img/a7.jpg')}}">
                                    </div>
                                    <div class="media-body">
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.9.1/dashboard_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 18 Jan 2019 10:33:23 GMT -->
</html>
