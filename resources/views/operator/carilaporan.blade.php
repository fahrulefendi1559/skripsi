                        ...
                        <div class="tab-content">
                            <div role="tabpanel" id="tab-1" class="tab-pane active">
                                <div class="panel-body">
                                     ...
                                     <div class="col-md-2 pull-left">
                                        <a href="{{ url('operator/laporan/suratmasuk/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                                     </div>
                                    <br> <br>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        @foreach($filtermasuk as $datalaporan)
                                        <tr >
                            ...
                            <div role="tabpanel" id="tab-2" class="tab-pane">
                                <div class="panel-body">
                                   ...
                                   <div class="col-md-2 pull-left">
                                        <a href="{{ url('operator/laporan/suratmasuk_ex/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                                  </div>
                                    <br> <br>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        @foreach($filtermasukex as $laporankeluar)
                                        <tr >
                            ...
                            <div role="tabpanel" id="tab-3" class="tab-pane">
                                <div class="panel-body">
                                   ...
                                   <div class="col-md-2 pull-left">
                                        <a href="{{ url('operator/laporan/suratkeluar/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                                  </div>
                                    <br> <br>
                                    <!-- laporan surat keluar -->
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        @foreach($filterkeluar as $laporankeluar)
                                        <tr >
                                            <td>{{$laporankeluar->nomorsurat}}</td>
                                            <td>{{$laporankeluar->pengirim}}</td>
                                            <td>{{$laporankeluar->penerima}}</td>
                            ...
                            <div role="tabpanel" id="tab-4" class="tab-pane">
                                <div class="panel-body">
                                   ...
                                   <div class="col-md-2 pull-left">
                                        <a href="{{ url('operator/laporan/suratkeluar_ex/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                                  </div>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        @foreach($filterkeluarex as $laporankeluar_ex)
                                        <tr >
                            ...
                            <div role="tabpanel" id="tab-5" class="tab-pane">
                                <div class="panel-body">
                                   <!-- laporan untuk surat tugas -->
                                   <div class="col-md-2 pull-left">
                                        <a href="{{ url('operator/laporan/surattugas/') }}" class="btn btn-primary btn-rounded btn-fw" target="blank"><b><i class="fa fa-download"></i> Cetak PDF</a></b>
                                  </div>
